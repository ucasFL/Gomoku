//计算棋盘信息，根据得分选择最佳落子位置,机器后手
#include "my_header.h"
//计算落子后各个方向的情况
int fcount_x(int x,int y,int p);
int fcount_y(int x,int y,int p);
int fcount_LtoR(int x,int y,int p);
int fcount_RtoL(int x,int y,int p);
//将落子后的情形转化为得分
int fnum_to_Score_Live(int num);
int fnum_to_Score_HalfLive(int num);
int fnum_to_Score_Death(int num);
int fother_score(int num);
//查找最高综合得分位置
void fGreatScore(int *Info_x,int *Info_y);
//用于记录器棋盘信息的数组
...
int Opp_4and4_x,Opp_4and4_y;
int Opp_h4and4_x,Opp_h4and4_y;
...
//machine_input 函数:获取电脑输入
void machine_input_mcf(int *x,int *y,int p){
        int My_Judge_Win=0,Opp_Judge_Win=0,Opp_Judge_LiveFour=0,My_Judge_LiveFour=0;
		int My_Judge_3and4=0,Opp_Judge_3and4=0;
        int My_Judge_o4and3=0,My_Judge_o4and4=0,My_Judge_o4ando4=0;
        int Opp_Judge_4and4=0,Opp_hJudge_4and4=0,Opp_Judge_o4and4=0;
        int Opp_Judge_2Three=0,Opp_Judge_o4ando4=0,Opp_Judge_o4and3=0;
	...
	for(i=0;i<SIZE;i++){
		for(j=0;j<SIZE;j++){
			if(aRecordBoard[i][j]!=0){
				...
				//计算棋盘信息：自己及对方
			    MyInfo[i][j][0]=fcount_x(i,j,FIRST_PLAYER);
			    MyInfo[i][j][1]=fcount_y(i,j,FIRST_PLAYER);
			    MyInfo[i][j][2]=fcount_LtoR(i,j,FIRST_PLAYER);
			    MyInfo[i][j][3]=fcount_RtoL(i,j,FIRST_PLAYER);
			    MyScore[i][j]=MyInfo[i][j][0]+MyInfo[i][j][1]+MyInfo[i][j][2]+MyInfo[i][j][3];
			    OppInfo[i][j][0]=fcount_x(i,j,SECOND_PLAYER);
			    OppInfo[i][j][1]=fcount_y(i,j,SECOND_PLAYER);
			    OppInfo[i][j][2]=fcount_LtoR(i,j,SECOND_PLAYER);
			    OppInfo[i][j][3]=fcount_RtoL(i,j,SECOND_PLAYER);
  ...
  int t=0;
	...
	for(i=0;i<SIZE;i++){
        ...
        //对方活四加半活四
        if((OppInfo[i][j][0]==LIVE_FOUR&&OppInfo[i][j][1]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][1]==LIVE_FOUR)||(OppInfo[i][j][0]==LIVE_FOUR&&OppInfo[i][j][2]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][2]==LIVE_FOUR)||(OppInfo[i][j][0]==LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==LIVE_FOUR)||(OppInfo[i][j][1]==LIVE_FOUR&&OppInfo[i][j][2]==HALF_LIVE_FOUR)||(OppInfo[i][j][1]==HALF_LIVE_FOUR&&OppInfo[i][j][2]==LIVE_FOUR)||(OppInfo[i][j][1]==LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][1]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==LIVE_FOUR)||(OppInfo[i][j][2]==LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][2]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==LIVE_FOUR)){
      Opp_4and4_x=i;
      Opp_4and4_y=j;
        Opp_Judge_4and4=1;
      }
      //对方半活四加半活四
      if((OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][1]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][1]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][2]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][2]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][0]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][1]==HALF_LIVE_FOUR&&OppInfo[i][j][2]==HALF_LIVE_FOUR)||(OppInfo[i][j][1]==HALF_LIVE_FOUR&&OppInfo[i][j][2]==HALF_LIVE_FOUR)||(OppInfo[i][j][1]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][1]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][2]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)||(OppInfo[i][j][2]==HALF_LIVE_FOUR&&OppInfo[i][j][3]==HALF_LIVE_FOUR)){
    Opp_h4and4_x=i;
    Opp_h4and4_y=j;
      Opp_hJudge_4and4=1;
    }
      ...
      if((OppInfo[i][j][0]==LIVE_THREE&&OppInfo[i][j][1]==LIVE_THREE)||(OppInfo[i][j][0]==LIVE_THREE&&OppInfo[i][j][2]==LIVE_THREE)||(OppInfo[i][j][0]==LIVE_THREE&&OppInfo[i][j][3]==LIVE_THREE)||(OppInfo[i][j][1]==LIVE_THREE&&OppInfo[i][j][2]==LIVE_THREE)||(OppInfo[i][j][1]==LIVE_THREE&&OppInfo[i][j][3]==LIVE_THREE)||(OppInfo[i][j][2]==LIVE_THREE&&OppInfo[i][j][3]==LIVE_THREE)){
        OppDouble_LiveThree_x=i;
        OppDouble_LiveThree_y=j;
          Opp_Judge_2Three=1;
      }
      //对方另一种活四＋半活四
  ...
  //对方活四加半活四
    if(Opp_Judge_4and4==1){
      *x=Opp_4and4_x;
      *y=Opp_4and4_y;
      return;
    }
      //对方活四加半活四
    if(Opp_hJudge_4and4==1){
      *x=Opp_h4and4_x;
      *y=Opp_h4and4_y;
      return;
    }
  ...
  //对方双活三
  if(Opp_Judge_2Three==1){
    *x=OppDouble_LiveThree_x;
    *y=OppDouble_LiveThree_y;
    return ;
  }
  //对方另一种半活四加活三
    ...
    if(x_count==1&&((Left_y>=2&&aRecordBoard[x][Left_y-1]==p&&aRecordBoard[x][Left_y-2]!=p&&aRecordBoard[x][Left_y-2]!=0)||(Right_y<=13&&aRecordBoard[x][Right_y+1]==p&&aRecordBoard[x][Right_y+2]!=p&&aRecordBoard[x][Right_y+2]!=0))){
      return fother_score(2);
		...
		if(x_count==2&&((Left_y>=2&&aRecordBoard[x][Left_y-1]==p&&aRecordBoard[x][Left_y-2]==0)||(Right_y<=13&&aRecordBoard[x][Right_y+1]==p&&aRecordBoard[x][Right_y+2]==0)))
		  x_count++;
	    return fnum_to_Score_Live(x_count);
	}
  //半活
    ...
    return fnum_to_Score_HalfLive(x_count);
  }
  //死
	else
	  return fnum_to_Score_Death(x_count);
}
//计算落子后竖直方向得分
int fcount_y(int x,int y,int p){
	extern int aRecordBoard[SIZE][SIZE];
    ...
    if(y_count==1&&((Up_x>=2&&aRecordBoard[Up_x-1][y]==p&&aRecordBoard[Up_x-2][y]!=p&&aRecordBoard[Up_x-2][y]!=0)||(Down_x<=13&&aRecordBoard[Down_x+1][y]==p&&aRecordBoard[Down_x+2][y]!=p&&aRecordBoard[Down_x+2][y]!=0))){
      return fother_score(2);
		...
		if(y_count==2&&((Up_x>=2&&aRecordBoard[Up_x-1][y]==p&&aRecordBoard[Up_x-2][y]==0)||(Down_x<=13&&aRecordBoard[Down_x+1][y]==p&&aRecordBoard[Down_x+2][y]==0)))
		  y_count++;
	  return fnum_to_Score_Live(y_count);
	}
  //半活
    ...
    return fnum_to_Score_HalfLive(y_count);
  }
	  //死
	else
	  return fnum_to_Score_Death(y_count);
}
//计算落子后左上到右下方向的得分
int fcount_LtoR(int x,int y,int p){
	extern int aRecordBoard[SIZE][SIZE];
    ...
    if(LtoR_count==1&&((Left_x>=2&&Left_y>=2&&aRecordBoard[Left_x-1][Left_y-1]==p&&aRecordBoard[Left_x-2][Left_y-2]!=p&&aRecordBoard[Left_x-2][Left_y-2]!=0)||(Right_y<=13&&Right_x<=13&&aRecordBoard[Right_x+1][Right_y+1]==p&&aRecordBoard[Right_x+2][Right_y+2]!=p&&aRecordBoard[Right_x+2][Right_y+2]!=0))){
      return fother_score(2);
		...
		if(LtoR_count==2&&((Left_x>=2&&Left_y>=2&&aRecordBoard[Left_x-1][Left_y-1]==p&&aRecordBoard[Left_x-2][Left_y-2]==0)||(Right_x<=13&&Right_y<=13&&aRecordBoard[Right_x+1][Right_y+1]==p&&aRecordBoard[Right_x+2][Right_y+2]==0)))
		  LtoR_count++;
	  return fnum_to_Score_Live(LtoR_count);
	}
  //半活
    ...
    return fnum_to_Score_HalfLive(LtoR_count);
  }
  //死
  else
	  return fnum_to_Score_Death(LtoR_count);
}
//计算从落子后左下到右上方向的得分
int fcount_RtoL(int x,int y,int p){
	extern int aRecordBoard[SIZE][SIZE];
    ...
    if(RtoL_count==1&&((Left_x<=13&&Left_y>=2&&aRecordBoard[Left_x+1][Left_y-1]==p&&aRecordBoard[Left_x+2][Left_y-2]!=p&&aRecordBoard[Left_x+2][Left_y-2]!=0)||(Right_y<=13&&Right_x>=2&&aRecordBoard[Right_x-1][Right_y+1]==p&&aRecordBoard[Right_x-2][Right_y+2]!=p&&aRecordBoard[Right_x-2][Right_y+2]!=0))){
      return fother_score(2);
		...
		if(RtoL_count==2&&((Left_x<=13&&Left_y>=2&&aRecordBoard[Left_x+1][Left_y-1]==p&&aRecordBoard[Left_x+2][Left_y-2]==0)||(Right_x>=2&&Right_y<=13&&aRecordBoard[Right_x-1][Right_y+1]==p&&aRecordBoard[Right_x-2][Right_y+2]==0)))
		  RtoL_count++;
	  return fnum_to_Score_Live(RtoL_count);
	}
  //半活
    ...
    return fnum_to_Score_HalfLive(RtoL_count);
  }
  //死
  else
	  return fnum_to_Score_Death(RtoL_count);
}
//查询综合得分最高的落子位置
void fGreatScore(int *Info_x,int *Info_y){
